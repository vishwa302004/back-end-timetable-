...
import com.example.timetable.auth.LoginRequest;
import com.example.timetable.auth.RegisterRequest;
import com.example.timetable.config.JwtToken;
import com.example.timetable.model.Token;
import com.example.timetable.model.User;
import com.example.timetable.repository.JwtRepo;
import com.example.timetable.repository.UserRepo;
